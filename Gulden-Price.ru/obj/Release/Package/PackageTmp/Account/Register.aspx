<%@ Page Title="Регистрация" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Gulden_Price.ru.Account.Register" %>
            ...
            <asp:CreateUserWizardStep runat="server" ID="RegisterUserWizardStep">
                <ContentTemplate>
                    <p class="message-info">
                        Пароль должен быть не меньше <%: Membership.MinRequiredPasswordLength %> символов.
                    </p>
